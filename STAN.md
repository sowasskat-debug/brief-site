...
- **Mobile: PANEL WĄTKÓW nad feedem** (2026-08-13) — pociągnięcie w dół (>60 px, na puszczenie)
  ...
  W ŚRODKU wątku przewijanie jest **natywne** (z bezwładnością systemu), a listener `scroll`
  **przycina je do górnej krawędzi wątku** — skok odpala dopiero następne przeciągnięcie, już z granicy. Bez tego przystanku gest
